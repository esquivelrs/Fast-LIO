...
def generate_launch_description():
    ...
    feature_extract_enable_param = LaunchConfiguration(
        "feature_extract_enable", default="false"
    )  # bool
    ...
    runtime_pos_log_enable_param = LaunchConfiguration(
        "runtime_pos_log_enable", default="false"
    )  # bool
